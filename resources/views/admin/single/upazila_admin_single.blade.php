	...
	<div class="box span12">
		...
		<div class="box-content">
			<div class="profile_image">
				<img   src="@if($staff_info->uzl_picture !=NULL) 
						{{URL::to("/public/Frontend/$staff_info->uzl_picture")}} @else {{URL::to("/public/Frontend/images/profile_img.jpg")}} @endif"> 
                  <h6>{{$staff_info->uzl_name}}</h6>  
                  <h6>{{$staff_info->uzl_working_area}}</h6>  
			...
			<table class="table table-striped"> 
	              <tbody> 
	                <tr>
	                  <td>Name:</td>
	                  <td>{{$staff_info->uzl_name}}</td> 
	                </tr>
	                <tr>
	                  <td>Father Name:</td>
	                  <td>{{$staff_info->uzl_fname}}</td> 
	                </tr> 
	                <tr>
	                  <td>Address:</td>
	                  <td>{{strip_tags($staff_info->uzl_address)}}</td> 
	                </tr>
	                 
	                <tr>
	                  <td>National ID Number:</td>
	                  <td>{{$staff_info->uzl_nid}}</td> 
	                </tr>
	                <tr>
	                  <td>Contact Number:</td>
	                  <td>{{$staff_info->uzl_mobile}}</td> 
	                </tr>
	                <tr>
	                  <td>Email:</td>
	                  <td>{{$staff_info->uzl_email}}</td> 
	                </tr>
	                
	                <tr>
	                  <td>Gender:</td>
	                  <td>@if($staff_info->uzl_gender==1) Male @else Female @endif</td> 
	                </tr>

	                <tr>
	                  <td>Date of Birth:</td>
	                  <td>{{$staff_info->uzl_birthday}}</td> 
	                </tr>
	                <tr>
	                  <td>Service Start:</td>
	                  <td>{{$staff_info->uzl_joining_date}}</td> 
	                </tr>
