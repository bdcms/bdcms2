	...
	<div class="box span12">
		...
		<div class="box-content">
			<div class="profile_image">
				<img   src="@if($staff_info->zil_picture !=NULL) 
						{{URL::to("/public/Frontend/$staff_info->zil_picture")}} @else {{URL::to("/public/Frontend/images/profile_img.jpg")}} @endif"> 
                  <h6>{{$staff_info->zil_name}}</h6>  
                  <h6>{{$staff_info->zil_working_area}}</h6>  
			...
			<table class="table table-striped"> 
	              <tbody> 
	                <tr>
	                  <td>Name:</td>
	                  <td>{{$staff_info->zil_name}}</td> 
	                </tr>
	                <tr>
	                  <td>Father Name:</td>
	                  <td>{{$staff_info->zil_fname}}</td> 
	                </tr> 
	                <tr>
	                  <td>Address:</td>
	                  <td>{{strip_tags($staff_info->zil_address)}}</td> 
	                </tr>
	                 
	                <tr>
	                  <td>National ID Number:</td>
	                  <td>{{$staff_info->zil_nid}}</td> 
	                </tr>
	                <tr>
	                  <td>Contact Number:</td>
	                  <td>{{$staff_info->zil_mobile}}</td> 
	                </tr>
	                <tr>
	                  <td>Email:</td>
	                  <td>{{$staff_info->zil_email}}</td> 
	                </tr>
	                
	                <tr>
	                  <td>Gender:</td>
	                  <td>@if($staff_info->zil_gender==1) Male @else Female @endif</td> 
	                </tr>

	                <tr>
	                  <td>Date of Birth:</td>
	                  <td>{{$staff_info->zil_birthday}}</td> 
	                </tr>
	                <tr>
	                  <td>Service Start:</td>
	                  <td>{{$staff_info->zil_joining_date}}</td> 
	                </tr>
