	...
	<div class="box span12">
		...
		<div class="box-content">
			<div class="profile_image">
				<img   src="@if($staff_info->ser_profile_pic !=NULL) 
						{{URL::to("/public/Frontend/$staff_info->ser_profile_pic")}} @else {{URL::to("/public/Frontend/images/profile_img.jpg")}} @endif"> 
                  <h6>{{$staff_info->ser_name}}</h6>  
                  <h6>{{$staff_info->ser_working_area}}</h6>  
                  <h6>{{$staff_info->ser_identity}}</h6>  
			...
			<table class="table table-striped"> 
	              <tbody> 
	                <tr>
	                  <td>Name:</td>
	                  <td>{{$staff_info->ser_name}}</td> 
	                </tr>  
	                <tr>
	                  <td>Address:</td>
	                  <td>{{strip_tags($staff_info->ser_address)}}</td> 
	                </tr>
	                 
	                <tr>
	                  <td>National ID Number:</td>
	                  <td>{{$staff_info->ser_nid}}</td> 
	                </tr>
	                <tr>
	                  <td>Contact Number:</td>
	                  <td>{{$staff_info->ser_mobile}}</td> 
	                </tr>
	                <tr>
	                  <td>Email:</td>
	                  <td>{{$staff_info->ser_email}}</td> 
	                </tr>
	                
	                <tr>
	                  <td>Gender:</td>
	                  <td>@if($staff_info->ser_gender==1) Male @else Female @endif</td> 
	                </tr>

	                <tr>
	                  <td>Date of Birth:</td>
	                  <td>{{$staff_info->ser_birthday}}</td> 
	                </tr>
	                <tr>
	                  <td>Service Start:</td>
	                  <td>{{$staff_info->ser_joining_date}}</td> 
	                </tr>
