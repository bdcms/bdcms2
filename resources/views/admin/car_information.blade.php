		...
		<div class="box-content">
			<div class="filter_table"> 
            	<form action="" method="Post">
					  ...
					  <div class="control-group">
						<label class="control-label" for="selectError3">Car Documents</label>
						<div class="controls">
						  <select id="selectError3">
							<option value="1">All Document</option>
	                        <option value="2">Insurence</option>
	                        <option value="3">Road Permit</option>
	                        <option value="4">Driving Lisence</option>
	                        <option value="5">Tax Payment</option> 
						  </select>
						</div>
					  </div>
					  <div class="control-group">
						<label class="control-label" for="selectError3">Clear Status</label>
						<div class="controls">
						  <select id="selectError3"> 
			...
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
			  ...
			  <tbody>
				...
				<tr>
					...
					<td class="center"><a href="{{$driver_info->id}}"> {{$driver_info->user_name}}</a></td>
					<td class="center">{{$value->car_name}}</td> 
				</tr>
				@endforeach 
			  </tbody>
		  </table>  
		  <form action="{{URL('/Print_Report')}}" method="Post" >
		  	{{csrf_field()}}
			<div class="form-actions"> 
